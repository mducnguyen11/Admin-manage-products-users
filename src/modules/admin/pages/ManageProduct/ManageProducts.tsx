...
import { IFilterProduct, IProductTableItem } from 'models/admin/product';
...
import { defaultFilterProductValue } from './components/ProductFilter/ultis';
      ...
      <div className="btn-wrapper">
        <div className="bottom-btns">
          {listProducts.some((a) => a.delete_checked == true) ? (
            <>
              <Button onClick={handleClickOpenModal} disabled={false} color="yellow" className="btn-save-change">
                Remove selected
              </Button>
              <Dialog
                open={open}
